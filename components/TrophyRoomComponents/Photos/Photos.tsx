...
function RENDER () {
    ...
    return (
        <Container id={styles.frameCont}>
            ...
            <pre onMouseEnter={() => clickLeftPhotoArrayDecrement()} style={{ color: 'rgb(247, 208, 32)', fontSize: "30px", cursor: 'none' }}> {left} </pre>        
                <img id={styles.photoImg} src={PHOTOS_ARRAY[OUTER_PHOTO_INDEX][NESTED_PHOTO_INDEX]}/>
            <pre onMouseEnter={() => clickRightPhotoArrayIncrement()} style={{ color: 'rgb(247, 208, 32)', fontSize: "30px", cursor: 'none' }}> {right} </pre>
            </Container>
