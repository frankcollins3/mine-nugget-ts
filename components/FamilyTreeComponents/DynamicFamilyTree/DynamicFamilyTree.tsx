  ...
  import styles from "components/FamilyTreeComponents/KingQueenPlaying/KingQueenPlaying.module.scss"
  ...
  export default function DynamicFamilyTree(props:any) {
      return <RENDER gameType={props.gameType}/>
  }
      ...
      guessCardPROMISE({card: CLICKED_CARD})
        ...
        return (
          ...
          <Container className={styles.cardColumn}>
            {
              ...
              : <img className={styles.kingQueenCard} src={luckypulldice}/>
            }
          {/* <img className={styles.kingQueenCard} src={GAME_OVER === "lose" ? joker : GAME_OVER === "win" ? kingspades : king}/> */}
          ...
          <Container className={styles.cardColumn}>
            {
              ...
              : <img className={styles.kingQueenCard} src={luckypullroulette}/>
          ...
          >            
          {
            ...
            : <img className="table" onClick={GAME_OVER ? resetCardGamePROMISE : tableClickGamePlay} id={styles.table} src={GAME_OVER === "win" ? trophy : luckypull}/>
          }
          {/* <img className="table" onClick={GAME_OVER ? resetCardGamePROMISE : tableClickGamePlay} id={styles.table} src={GAME_OVER === "win" ? trophy : kingqueensplit}/> */}
          </Droppable>
          ...
          <img id="0" onClick={cardClick} onMouseEnter={() => dispatch(TOGGLE_TERNARY_RENDER_OPTION_0())} onMouseLeave={() => dispatch(TOGGLE_TERNARY_RENDER_OPTION_0())} className={styles.card} src={gameType === "pairents" ? upsidedowncard : coin}/>
          </Draggable>
  ...
  {TERNARY_RENDER_OPTION_0 && <pre style={{ fontSize: '14px' }} className={styles.cardText}> {WRONG_RIGHT_OPTION_BUCKET[0]} </pre>  }
          ...
          <img id="1" onClick={cardClick} onMouseEnter={() => dispatch(TOGGLE_TERNARY_RENDER_OPTION_1())} onMouseLeave={() => dispatch(TOGGLE_TERNARY_RENDER_OPTION_1())} className={styles.card} src={gameType === "pairents" ? upsidedowncard : coin}/>
          </Draggable>
          ...
          <img id="2" onClick={cardClick} onMouseEnter={() => dispatch(TOGGLE_TERNARY_RENDER_OPTION_2())} onMouseLeave={() => dispatch(TOGGLE_TERNARY_RENDER_OPTION_2())} className={styles.card} src={gameType === "pairents" ? upsidedowncard : coin}/>
          ...
          <img id="3" onClick={cardClick} onMouseEnter={() => dispatch(TOGGLE_TERNARY_RENDER_OPTION_3())} onMouseLeave={() => dispatch(TOGGLE_TERNARY_RENDER_OPTION_3())} className={styles.card} src={gameType === "pairents" ? upsidedowncard : coin}/>
